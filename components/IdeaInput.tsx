  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newCards = ideasToProcess.map(idea => {
      ...
      if (defaultStatus) {
        ...
        // Fix: Changed WorkflowStage.Published to WorkflowStage.PublishedAnalyticsReview as 'Published' does not exist in the enum.
        if (defaultStatus === WorkflowStage.PublishedAnalyticsReview) {
